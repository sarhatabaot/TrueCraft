...
namespace TrueCraft.Serialization
{
	...
	public sealed class NbtFile
	{
		...
		public int SaveToFile([NotNull] string fileName, NbtCompression compression)
		{
			...
			using (var saveFile = File.Create(fileName)) return SaveToStream(saveFile, compression);
		}
		...
		public int SaveToStream([NotNull] Stream stream, NbtCompression compression)
		{
			...
			if (rootTag == null) throw new NbtFormatException("Cannot save NbtFile: No root tag.");
